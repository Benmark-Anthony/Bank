      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 p-6`}>
        <div className="flex flex-row item-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
          ...
          <p className={`${styles.paragraph} ml-2`}>
            ...
            <span className="text-white"> all transations</span>
          </p>
        </div>
          ...
          Our team of experts uses a methodology to identify the easy transition method most likely to fit your needs. 
